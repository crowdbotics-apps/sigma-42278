"""
Django settings for sigma_42278 project.
...
WSGI_APPLICATION = 'sigma_42278.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sigma_42278 API",
    "DESCRIPTION": "API documentation for sigma_42278 App",
    "VERSION": "v1",
}
